...
$price = 0;
 ...
 <li class="list-group-item d-flex justify-content-between lh-sm">
        ...
        ?>
              ...
              <small class="text-muted">Quantity <?php echo $value['productquantity'] ; ?></small>
            </div>
            <span class="text-muted">
            <?php 
          $price = $price + ($v['productprice']*$value['productquantity']);
          echo '$'.$v['productprice']*$value['productquantity'];
          ?>
            </span>
          </li>
